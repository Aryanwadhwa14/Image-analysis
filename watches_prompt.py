...
def main():
    # Define the folders and their order for watches
    folders = [
        ("Watches/watch", "watches only"),
        ("Watches/model-watch", "model with watches")
    ]
    ...
    print(f"Found {len(image_paths)} watch images to process")
    print("=" * 50)
    ...
    txt_filename = "watches_prompt_output.txt"
    ...
    print(f"Successfully processed {len(results)} watch images")
    
    # Print summary
    print("\nSummary of processed watch images:")
    for result in results:
