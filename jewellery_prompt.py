...
def main():
    # Define the folders and their order for jewellery
    folders = [
        ("jewellery/jewel-images", "jewellery only"),
        ("jewellery/Model-jewellery", "model with jewellery")
    ]
    ...
    print(f"Found {len(image_paths)} jewellery images to process")
    print("=" * 50)
    ...
    txt_filename = "jewellery_prompt_output.txt"
    ...
    print(f"Successfully processed {len(results)} jewellery images")
    
    # Print summary
    print("\nSummary of processed jewellery images:")
    for result in results:
