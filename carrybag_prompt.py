...
genai.configure(api_key="AIzaSyDN7VVL8Lne1kqA1tI1j-CfCGvn9BYyJf8")
...
def main():
    # Define the folders and their order for carrybags
    folders = [
        ("carrybags/carrybag", "carrybag only"),
        ("carrybags/Model-carrybag", "carrybag with model")
    ]
    ...
    print(f"Found {len(image_paths)} carrybag images to process")
    print("=" * 50)
    ...
    txt_filename = "carrybag_prompt_output.txt"
    ...
    print(f"Successfully processed {len(results)} carrybag images")
    
    # Print summary
    print("\nSummary of processed carrybag images:")
    for result in results:
